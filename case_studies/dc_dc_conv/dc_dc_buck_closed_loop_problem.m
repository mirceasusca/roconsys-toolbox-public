...
% TODO: hybrid with three states when iL = 0 (DCM)

%% 1) define plant and uncertainty bounds/options
clearvars
GF = UncertainBuckConverterFactory();
GHF = UncertainHybridBuckConverterFactory();

%% simulate time response near equilibrium point
timeSimOpts = set_time_sim_options();
timeSimOpts.tfin = 0.025;
